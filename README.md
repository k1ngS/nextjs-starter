...
- [base](https://github.com/k1ngS/next-starter/tree/base)
  - eslint / prettier settings
- [nextui](https://github.com/k1ngS/next-starter/tree/nextui)
  - layout / styles
  - dark / light theme toggle
- [typesafe-env](https://github.com/k1ngS/next-starter/tree/typesafe-env)
  - typesafe environment variables
- [next-auth](https://github.com/k1ngS/next-starter/tree/next-auth)
  - google oauth with no database
- [drizzle](https://github.com/k1ngS/next-starter/tree/drizzle) / [main](https://github.com/k1ngS/next-starter)
